...
void FachadaDebate::realizarProximaRodada() {
    ...
    // Sorteia quem vai PERGUNTAR
    DadosCandidato dInquiridor = gerencia.sortearInquiridorPendente();
    
    // Interação com o terminal para escolher quem vai RESPONDER
    ...
    // Cria as instâncias dos políticos com todos os seus eleitores
    ...
    // Repassa para o Mediador iniciar a rodada
    std::cout << "\n============================================\n";
